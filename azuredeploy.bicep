...
resource ingestfunction 'Microsoft.Web/sites/extensions@2015-08-01' = {
  ...
  properties: {
    packageUri: 'hhttps://cdn.glitch.me/749e2e85-0cea-4e1a-8f92-0db2d30224de/car-kafka-funcss.zip?v=1709542263700'
    dbType: 'None'
    connectionString: ''
  }
  dependsOn: [
...
resource PostDeploymentscript 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  properties: {
    ...
    primaryScriptUri: 'https://raw.githubusercontent.com/Thiennam209/adtcarkafka/main/postdeploy.sh'
